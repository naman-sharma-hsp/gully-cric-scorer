...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gully Cricket Scorer is a mobile app for scoring and managing local cricket matches." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Gully Cricket Scorer" },
      { property: "og:description", content: "Gully Cricket Scorer is a mobile app for scoring and managing local cricket matches." },
